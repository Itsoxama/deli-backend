...
const { registerCustomer, getAllCustomers,getCustomersByPage, getAllStats, getCustomerStats, overviewCustomers, updateCustomer } = require("./Customer.controller.js");
